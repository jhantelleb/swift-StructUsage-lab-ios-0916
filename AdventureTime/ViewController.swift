...
class ViewController: UIViewController {
    ...
    func createAllCharacters() {
        ...
        bubblegum = Character(name: "Princess Bubblegum", species: "Princess", occupation: "Hero", powerLevel: 25.0)
        lemongrab = Character(name: "Lemongrab", species: "Lemon", occupation: "Villain", powerLevel: 45.0)
        bmo = Character(name: "BMO", species: "Robot", occupation: "Hero", powerLevel: 20.0)
        lsp = Character(name: "Lumpy Space Princess", species: "Lumpy", occupation: "Villain", powerLevel: 50.0)
    }
